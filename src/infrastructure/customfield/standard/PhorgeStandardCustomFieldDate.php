...
final class PhorgeStandardCustomFieldDate
  ...
  public function renderPropertyViewValue(array $handles) {
    ...
    return phorge_datetime($value, $this->getViewer());
  }
  ...
  public function getApplicationTransactionTitle(
    ...
    $old_date = null;
    if ($old) {
      $old_date = phorge_datetime($old, $viewer);
    }

    $new_date = null;
    if ($new) {
      $new_date = phorge_datetime($new, $viewer);
    }
