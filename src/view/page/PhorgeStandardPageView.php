...
final class PhorgeStandardPageView extends PhorgeBarePageView
  ...
  public function setTabs(PHUIListView $tabs) {
    ...
    $tabs->addClass('phorge-standard-page-tabs');
    $this->tabs = $tabs;
    return $this;
  }
  ...
  protected function willRenderPage() {
    ...
    require_celerity_resource('phorge-core-css');
    require_celerity_resource('phorge-zindex-css');
    require_celerity_resource('phui-button-css');
    require_celerity_resource('phui-spacing-css');
    require_celerity_resource('phui-form-css');
    require_celerity_resource('phorge-standard-page-view');
    ...
    Javelin::initBehavior('phorge-gesture');
  ...
  protected function getHead() {
    ...
    return hsprintf(
      ...
      parent::getHead(),
      $font_css,
      $response->renderSingleResource('javelin-magical-init', 'phorge'));
  }
  ...
  protected function getBody() {
    ...
    $main_page = phutil_tag(
      'div',
      array(
        'id' => 'phorge-standard-page',
        'class' => 'phorge-standard-page',
      ),
      array(
        $developer_warning,
        $header_chrome,
        phutil_tag(
          'div',
          array(
            'id' => 'phorge-standard-page-body',
            'class' => 'phorge-standard-page-body',
          ),
  ...
  protected function getBodyClasses() {
    ...
    if (!$this->getShowChrome()) {
      $classes[] = 'phorge-chromeless-page';
    }
  ...
  private function renderFooter() {
    ...
    return phutil_tag(
      'div',
      array(
        'class' => 'phorge-standard-page-footer grouped',
      ),
      $foot);
  }
