...
final class PhorgeMainMenuView extends AphrontView {
  ...
  public function render() {
    ...
    require_celerity_resource('phorge-main-menu-view');
    ...
    $classes = array();
    $classes[] = 'phorge-main-menu';
    $classes[] = 'phorge-main-menu-background';
  ...
  private function renderSearch() {
    ...
    Javelin::initBehavior(
      'phorge-keyboard-shortcuts',
      $keyboard_config);

    if ($result) {
      $result = id(new PHUIListItemView())
        ->addClass('phorge-main-menu-search')
        ->appendChild($result);
    }
  ...
  public function renderApplicationMenuButton() {
    ...
    return id(new PHUIButtonView())
      ...
      ->addClass('phorge-core-user-mobile-menu')
      ->setNoCSS(true)
  ...
  public function renderSearchMenuButton($header_id) {
    ...
    return javelin_tag(
      'a',
      array(
        'class' => 'phorge-main-menu-search-button '.
                   'phorge-expand-application-menu',
        'sigil' => 'jx-toggle-class',
        'meta'  => array(
          'map' => array(
            $header_id => 'phorge-search-menu-expanded',
      ...
      'span',
      array(
        'class' => 'phorge-menu-button-icon phui-icon-view '.
  ...
  private function renderPhorgeLogo() {
    ...
    $logo_node = phutil_tag(
      'span',
      array(
        'class' => 'phorge-main-menu-project-logo',
  ...
  private function renderNotificationMenu() {
    ...
    if ($conpherence_data['isInstalled']) {
      ...
      $message_count_tag = phutil_tag(
        ...
        array(
          'id'    => $message_count_id,
          'class' => 'phorge-main-menu-message-count',
        ),
      ...
      $message_icon_tag = javelin_tag(
        'span',
        array(
          'class' => 'phorge-main-menu-message-icon phui-icon-view '.
      ...
      $message_notification_dropdown = javelin_tag(
        ...
        array(
          ...
          'class' => 'phorge-notification-menu',
    ...
    if ($notification_data['isInstalled']) {
      ...
      $count_tag = phutil_tag(
        ...
        array(
          'id'    => $count_id,
          'class' => 'phorge-main-menu-alert-count',
        ),
      ...
      $icon_tag = javelin_tag(
        'span',
        array(
          'class' => 'phorge-main-menu-alert-icon phui-icon-view '.
    ...
    if ($viewer && $viewer->getIsAdmin()) {
      ...
      if ($open) {
        ...
        $setup_count_tag = phutil_tag(
          ...
          array(
            'id'    => $setup_count_id,
            'class' => 'phorge-main-menu-setup-count',
          ),
          $setup_count_number);
        ...
        $setup_icon_tag = javelin_tag(
          'span',
          array(
            'class' => 'phorge-main-menu-setup-icon phui-icon-view '.
