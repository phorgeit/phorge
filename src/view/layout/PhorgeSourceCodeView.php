  ...
  public function render() {
    ...
    foreach ($lines as $line) {
      ...
      if (isset($this->highlights[$line_number])) {
        ...
        if (!$wrote_anchor) {
          $row_attributes['id'] = 'phorge-line-linker-anchor';
          $wrote_anchor = true;
        }
      }
      ...
      if ($has_blame) {
        ...
        $blame_cells = array(
          phutil_tag(
            'th',
            array(
              'class' => 'phorge-source-blame-skip',
              'data-blame' => $skip_blame,
            )),
          phutil_tag(
            'th',
            array(
              'class' => 'phorge-source-blame-info',
