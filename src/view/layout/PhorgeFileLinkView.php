...
final class PhorgeFileLinkView extends AphrontTagView {
  ...
  protected function getTagAttributes() {
    $class = 'phorge-remarkup-embed-layout-link';
  ...
  protected function getTagContent() {
    ...
    $icon = id(new PHUIIconView())
      ...
      ->addClass('phorge-remarkup-embed-layout-icon');
    ...
    if ($download_uri) {
      ...
      $download_link = phutil_tag(
        'a',
        array(
          'class' => 'phorge-remarkup-embed-layout-download',
          'href' => $download_uri,
        ),
        pht('Download'));
    }
    ...
    $info = phutil_tag(
      'span',
      array(
        'class' => 'phorge-remarkup-embed-layout-info',
      ),
      $this->getFileSize());
    ...
    $name = phutil_tag(
      'span',
      array(
        'class' => 'phorge-remarkup-embed-layout-name',
      ),
      $this->getFileName());
    ...
    $inner = phutil_tag(
      'span',
      array(
        'class' => 'phorge-remarkup-embed-layout-info-block',
      ),
      array(
        $name,
        $info,
