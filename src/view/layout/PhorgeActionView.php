  ...
  public function render() {
    ...
    if ($this->icon) {
      ...
      $icon = id(new PHUIIconView())
        ->addClass('phorge-action-view-icon')
    ...
    $classes = array();
    $classes[] = 'phorge-action-view';

    if ($this->disabled) {
      $classes[] = 'phorge-action-view-disabled';
    }

    if ($this->label) {
      $classes[] = 'phorge-action-view-label';
    }

    if ($this->selected) {
      $classes[] = 'phorge-action-view-selected';
    }

    if ($this->submenu) {
      $classes[] = 'phorge-action-view-submenu';
    }

    if ($this->getHref()) {
      $classes[] = 'phorge-action-view-href';
    }
    ...
    if ($this->type) {
      $classes[] = 'phorge-action-view-'.$this->type;
    }
