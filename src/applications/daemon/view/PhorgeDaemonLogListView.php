...
final class PhorgeDaemonLogListView extends AphrontView {

  private $daemonLogs;

  public function setDaemonLogs(array $daemon_logs) {
    assert_instances_of($daemon_logs, 'PhorgeDaemonLog');
  ...
  public function render() {
    ...
    foreach ($daemons as $daemon) {
      ...
      $launched = phorge_datetime($daemon->getDateCreated(), $viewer);
