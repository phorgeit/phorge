...
final class PhorgeOwnersPackageAuditingTransaction
  ...
  public function generateNewValue($object, $value) {
    return PhorgeOwnersAuditRule::getStorageValueFromAPIValue($value);
  }
  ...
  public function getTitle() {
    ...
    $old_rule = PhorgeOwnersAuditRule::newFromState($old_value);
    $new_rule = PhorgeOwnersAuditRule::newFromState($new_value);
  ...
  public function validateTransactions($object, array $xactions) {
    ...
    $modern_options = PhorgeOwnersAuditRule::getModernValueMap();
    $deprecated_options = PhorgeOwnersAuditRule::getDeprecatedValueMap();
