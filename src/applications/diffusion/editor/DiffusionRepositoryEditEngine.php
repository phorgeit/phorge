...
final class DiffusionRepositoryEditEngine
  ...
  protected function newEditableObject() {
    ...
    $repository = PhorgeRepository::initializeNewRepository($viewer);
  ...
  protected function buildCustomEditFields($object) {
    ...
    return array(
      id(new PhorgeSelectEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryVCSTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setIsRequired(true)
        ->setTransactionType(
          PhorgeRepositoryNameTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryCallsignTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositorySlugTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeRemarkupEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryDescriptionTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setIsCopyable(true)
        ->setTransactionType(
          PhorgeRepositoryEncodingTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeSelectEditField())
        ...
        ->setIsFormField(false)
        ->setOptions(PhorgeRepository::getStatusNameMap())
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryDefaultBranchTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeTextAreaEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryFetchRefsTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeTextAreaEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryPermanentRefsTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeTextAreaEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryTrackOnlyTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositorySVNSubpathTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryStagingURITransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeDatasourceEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryBlueprintsTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgeStringListEditField())
        ...
        ->setTransactionType(
          PhorgeRepositorySymbolLanguagesTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
        ->setDescription(
      ...
      id(new PhorgeDatasourceEditField())
        ...
        ->setTransactionType(
          PhorgeRepositorySymbolSourcesTransaction::TRANSACTIONTYPE)
        ->setIsCopyable(true)
      ...
      id(new PhorgePolicyEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryPushPolicyTransaction::TRANSACTIONTYPE)
        ->setDescription(
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryFilesizeLimitTransaction::TRANSACTIONTYPE)
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryCopyTimeLimitTransaction::TRANSACTIONTYPE)
        ->setDescription(
      ...
      id(new PhorgeTextEditField())
        ...
        ->setTransactionType(
          PhorgeRepositoryTouchLimitTransaction::TRANSACTIONTYPE)
