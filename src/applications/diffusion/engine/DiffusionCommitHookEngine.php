...
final class DiffusionCommitHookEngine extends Phobject {
  ...
  const ENV_REPOSITORY = 'PHORGE_REPOSITORY';
  const ENV_USER = 'PHORGE_USER';
  const ENV_REQUEST = 'PHORGE_REQUEST';
  const ENV_REMOTE_ADDRESS = 'PHORGE_REMOTE_ADDRESS';
  const ENV_REMOTE_PROTOCOL = 'PHORGE_REMOTE_PROTOCOL';
