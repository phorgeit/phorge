...
final class PhabricatorTypeaheadFunctionHelpController
  ...
  public function handleRequest(AphrontRequest $request) {
    ...
    if (!$functions) {
      $content[] = pht(
      'This control does not support typeahead functions.');
    } else {
      ...
      $content[] = pht(
        "In addition to typing user and project names to build queries, you ".
        "can also type the names of special functions which give you more ".
        "options and the ability to express more complex queries.\n\n".
        "Functions have an internal name (like `%s`) and a human-readable ".
        "name, like `Current Viewer`. In general, you can type either one to ".
        "select the function. You can also click the {nav icon=search} ".
        "button on any typeahead control to browse available functions and ".
