...
final class PhorgeMySQLConfigOptions
  ...
  public function getOptions() {
    return array(
      ...
      $this->newOption('storage.default-namespace', 'string', 'phorge')
        ->setLocked(true)
        ->setSummary(
        ...
        ->setDescription(
          pht(
            ...
            "'phorge' -- for instance, the Differential database is ".
            "named 'phorge_differential' by default. You can change ".
