...
final class PhabricatorExtraConfigSetupCheck extends PhabricatorSetupCheck {
  ...
  public static function getAncientConfig() {
    ...
    $auth_config = array(
      ...
      'phorge.oauth-uri',
      'phorge.auth-enabled',
      'phorge.registration-enabled',
      'phorge.auth-permanent',
      'phorge.application-id',
      'phorge.application-secret',
    );
    ...
    $ancient_config += array(
      ...
      'phorge.show-beta-applications' => pht(
