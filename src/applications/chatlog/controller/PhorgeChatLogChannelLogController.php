...
final class PhorgeChatLogChannelLogController
  ...
  public function handleRequest(AphrontRequest $request) {
    ...
    require_celerity_resource('phorge-chatlog-css');
    ...
    foreach ($blocks as $block) {
      ...
      $timestamp = phorge_datetime($timestamp, $viewer);
    ...
    $pager_bottom = phutil_tag(
      'div',
      array('class' => 'phorge-chat-log-pager-bottom'),
      $links);
