...
final class PhorgeEmbedFileRemarkupRule
  ...
  private function renderImageFile(
    ...
    $attrs = array();
    $image_class = 'phorge-remarkup-embed-image';
    ...
    if ($use_size) {
      switch ((string)$options['size']) {
        case 'full':
          ...
          $image_class = 'phorge-remarkup-embed-image-full';
          break;
        ...
        case 'wide':
          ...
          $image_class = 'phorge-remarkup-embed-image-wide';
          break;
        case 'thumb':
        default:
    ...
    switch ($options['layout']) {
      ...
      case 'inline':
      case 'left':
        $layout_class = 'phorge-remarkup-embed-layout-'.$options['layout'];
        break;
      default:
        $layout_class = 'phorge-remarkup-embed-layout-left';
        break;
    }
    ...
    if ($options['float']) {
      switch ($options['layout']) {
        ...
        case 'inline':
          break;
        case 'right':
          $layout_class .= ' phorge-remarkup-embed-float-right';
          break;
        case 'left':
        default:
          $layout_class .= ' phorge-remarkup-embed-float-left';
          break;
      }
    }
